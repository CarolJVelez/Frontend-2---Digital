...
while (marcador.usuario < 2 && marcador.computadora < 2) {
    ...
    alert("Partidas: "+marcador.partidasJugadas+"  Marcador final Pc: "+marcador.computadora+" Usuario: "+marcador.usuario+" Empates: "+marcador.empates)
    console.log(marcador.partidasJugadas);
}
