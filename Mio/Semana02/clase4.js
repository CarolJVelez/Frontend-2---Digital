...
const imagenes = document.querySelectorAll (".noticias article imag")
...
main.innerHTML = ""//borrar el contenido que tenia en el main, para agregar todo dinamico
//insercion de nodos tecnica
listadoNoticias.forEach(noticia =>{
    //crear elementos nuevos que no existen en el dom
    const article = document.createElement("article")
    const h2 = document.createElement("h2")
    const img = document.createElement("img")
    const p = document.createElement("p")

    //agregamos los textos, los atributos de cada etiqueta creada
    ...
    //agrego h2, img y p a la etiqueta padre article
    article.appendChild(h2)//tecnicade insercion de nodos
    article.appendChild(img)
    article.appendChild(p)

    //agrego el article creado al elemtnto padre que seria el contenerdor de la noticia
